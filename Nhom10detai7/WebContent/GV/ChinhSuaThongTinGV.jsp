...
<div class="col-md-9" >
 <h4 align="Center" style="background-color:#8258FA;color:white;line-height:40px;font-size:17px">Chỉnh Sửa Thông Tin Cá Nhân</h4>
	<form name="myForm" class="form-horizontal">
		<div class="form-group">
			<label class="control-label col-sm-4 ng-invalid ng-invalid-required ng-dirty ng-valid-parse">Họ Và Tên: </label>
			<div  class="col-sm-4">
		...
		<div class="form-group">
			<label class="control-label col-sm-4 ng-dirty ng-invalid ng-invalid-email">Email: </label>
			<div class="col-sm-4">
		...
		<div class="form-group">
			<label class="control-label col-sm-4">SDT: </label>
			<div class="col-sm-4">
		...
		<div class="form-group">
			<label class="control-label col-sm-4">Hiện Đang Công Tác Tại: </label>
			<div class="col-sm-4">
		...
		<div class="form-group">
			<label class="control-label col-sm-4">Giảng Viên Môn: </label>
			<div class="col-sm-4">
