...
<div class="container-fluid" style="line-height:20px">
  ...
  <span class="#"></span>Tài Liệu Học Tập</a>
	...
	<div class="col-md-9" >
		...
		<h5>Tên Bài Tập: <input type="text" class="form-control"><button type="submit" style="margin-left: 50px">Thêm Bài Tập</center></h5>
	<h5>Thời gian: <input type="number" name="quantity" min="1" max="120" class="form-control"> phút</h5>
	<h5>Câu 1:<input type="text" class="form-control"> </h5>
	<input type="radio" name ="C1"><input type="text" class="form-control"> <br>
	<input type="radio" name ="C1"><input type="text" class="form-control"> <br>
	<input type="radio" name ="C1"><input type="text" class="form-control"> <br>
	<input type="radio" name ="C1"><input type="text" class="form-control"> <br>
	
	<h5>Câu 2:<input type="text" class="form-control"> </h5>
	<input type="radio" name ="C1"><input type="text" class="form-control"> <br>
	<input type="radio" name ="C1"><input type="text" class="form-control"> <br>
	<input type="radio" name ="C1"><input type="text" class="form-control"> <br>
	<input type="radio" name ="C1"><input type="text" class="form-control"> <br>

	<h5>Câu 3:<input type="text" class="form-control"> </h5>
	<input type="radio" name ="C1"><input type="text" class="form-control"> <br>
	<input type="radio" name ="C1"><input type="text" class="form-control"> <br>
	<input type="radio" name ="C1"><input type="text" class="form-control"> <br>
	<input type="radio" name ="C1"><input type="text" class="form-control"> <br>

	<h5>Câu 4:<input type="text" class="form-control"> </h5>
	<input type="radio" name ="C1"><input type="text" class="form-control"> <br>
	<input type="radio" name ="C1"><input type="text" class="form-control"> <br>
	<input type="radio" name ="C1"><input type="text" class="form-control"> <br>
	<input type="radio" name ="C1"><input type="text" class="form-control"> <br>

	<h5>Câu 5:<input type="text" class="form-control"> </h5>
	<input type="radio" name ="C1"><input type="text" class="form-control"> <br>
	<input type="radio" name ="C1"><input type="text" class="form-control"> <br>
	<input type="radio" name ="C1"><input type="text" class="form-control"> <br>
	<input type="radio" name ="C1"><input type="text" class="form-control"> <br>

	<h5>Câu 6:<input type="text" class="form-control"> </h5>
	<input type="radio" name ="C1"><input type="text" class="form-control"> <br>
	<input type="radio" name ="C1"><input type="text" class="form-control"> <br>
	<input type="radio" name ="C1"><input type="text" class="form-control"> <br>
	<input type="radio" name ="C1"><input type="text" class="form-control"> <br>
