	...
	<div class="col-md-9" >
		...
		<form name="myForm" class="form-horizontal">
			<div class="form-group">
				...
				<div class="col-sm-4"><input type="password" name="pws1" id="MK1" class="form-control" onkeyup="checkPass()">
				<span id="z-MK1"></span></div>
				
			</div>
				<div class="form-group">
				<label class="control-label col-sm-4">Mật khẩu mới: </label>
				<div class="col-sm-4"><input type="password" name="pws2" id="MK2" class="form-control" maxlength="20" onkeyup="checkPass()">
				<span id="z-MK2"></span></div>
				
			</div>
			<div class="form-group">
				<label class="control-label col-sm-4">Xác Nhận Mật Khẩu: </label>
				<div class="col-sm-4"><input type="password" name="re_pws2" id="re_MK2" class="form-control" maxlength="20" onkeyup="password()">
				<span id="z-re_MK2"></span></div>
