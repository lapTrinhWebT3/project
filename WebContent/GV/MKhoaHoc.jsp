  ...
  <span class="#"></span>Tài Liệu Học Tập</a>
	...
	<div class="col-md-9" >
		...
		<form name="myForm" class="form-horizontal">
			<div class="form-group">
				<label class="control-label col-sm-4 ng-invalid ng-invalid-required ng-dirty ng-valid-parse">Tên Môn Học: </label>
				<div class="col-sm-4"><input name="myName" ng-model="myName" required="" class="form-control ng-touched ng-dirty ng-valid-parse ng-invalid ng-invalid-required">
				<span ng-show="myForm.myName.$touched &amp;&amp; myForm.myName.$invalid" class="ng-hide">Tên môn học không được để trống! </span></div>
				
			</div>
			<div class="form-group">
				<label class="control-label col-sm-4"> Thời gian bắt đầu: </label>
				<div class="col-sm-4"><input type="date" class="form-control" id ="sday" min="1954-01-01" max="2050-12-31" onclick="checkDate()" onkeyup="checkDate()">
				<span id="z-sday"></span></div>
				
			</div>
			<div class="form-group">
				<label class="control-label col-sm-4"> Thời gian kết thúc: </label>
				<div class="col-sm-4"><input type="date" class="form-control"  id="eday"  min="1954-01-01" max="2050-12-31" onclick="checkDate()" onkeyup="checkDate()">
				<span id="z-eday"> </span></div>
				
			</div>
			<div class="form-group">
				<label class="control-label col-sm-4"> Sĩ số: </label>
				<div class="col-sm-4"><input type="tel" class="form-control" id="tel"></div>
				
				
			</div>
			<div class="form-group">
				<label class="control-label col-sm-4"> Lịch học: </label>
				<div class="col-sm-4"><input type="text" class="form-control"></div>
						
			</div>
			<div class="form-group">
				<label class="control-label col-sm-4"> Địa diểm: </label>
				<div class="col-sm-4"><input type="text" class="form-control"></div>
				
			</div>
			<div class="form-group">
				<label class="control-label col-sm-4"> Mô tả khóa học: </label>
				<div class="col-sm-4"><textarea cols="30" rows="5"></textarea></div>	
			</div>
			<div class="form-group">
