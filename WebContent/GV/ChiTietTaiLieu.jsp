...
<div class="container-fluid" style="line-height:20px">
  ...
  <span class="#"></span>Kế Hoạch Học Tập</a>
    <a href="Tailieu.jsp" class="list-group-item active">
    ...
    <table class="table" align="center">
          ...
          <tbody>
            <tr>
              ...
              <td>Bài giảng tuần 1</td>
              <td><a href="ChiTietKeHoach1.jsp" download=""><span class="glyphicon glyphicon-download-alt"></span></a></td>
            </tr>
            <tr>
              <td>2</td>
              <td>Lập Trình C++ Căn bản</td>
              <td>Bài giảng tuần 2</td>
              <td><a href="ChiTietKeHoach1.jsp" download=""><span class="glyphicon glyphicon-download-alt"></span></a></td>
            </tr>
          </tbody>
    </table>
       <a href="ThemTL.jsp" class="button"> <button type="submit">Thêm Tài Liệu</button></a>
